...
class MeApi {
  ...
  /// Returns a [Future] containing a [Response] with a [MeOut] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeOut>> patchMe({
    required MePatch mePatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(MePatch);
      _bodyData = _serializers.serialize(mePatch, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
