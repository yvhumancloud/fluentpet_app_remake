...
/// * [email]
@BuiltValue()
abstract class InvitationCreate
    implements Built<InvitationCreate, InvitationCreateBuilder> {
  @BuiltValueField(wireName: r'email')
  String get email;

  InvitationCreate._();

  factory InvitationCreate([void updates(InvitationCreateBuilder b)]) =
      _$InvitationCreate;
  ...
  static Serializer<InvitationCreate> get serializer =>
      _$InvitationCreateSerializer();
}

class _$InvitationCreateSerializer
    implements PrimitiveSerializer<InvitationCreate> {
  @override
