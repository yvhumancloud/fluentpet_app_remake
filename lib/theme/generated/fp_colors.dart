...
class FpColors extends ThemeExtension<FpColors> {
  ...
  FpColors copyWith({
    ...
    return FpColors(
      ...
      actionPrimaryBgPressed: actionPrimaryBgPressed ?? this.actionPrimaryBgPressed,
      actionPrimaryBgDisabled: actionPrimaryBgDisabled ?? this.actionPrimaryBgDisabled,
      actionPrimaryFg: actionPrimaryFg ?? this.actionPrimaryFg,
      actionPrimaryFgDisabled: actionPrimaryFgDisabled ?? this.actionPrimaryFgDisabled,
      actionSecondaryBg: actionSecondaryBg ?? this.actionSecondaryBg,
      actionSecondaryBgHover: actionSecondaryBgHover ?? this.actionSecondaryBgHover,
      actionSecondaryBgPressed: actionSecondaryBgPressed ?? this.actionSecondaryBgPressed,
      actionSecondaryBgDisabled: actionSecondaryBgDisabled ?? this.actionSecondaryBgDisabled,
      actionSecondaryFg: actionSecondaryFg ?? this.actionSecondaryFg,
      actionSecondaryFgDisabled: actionSecondaryFgDisabled ?? this.actionSecondaryFgDisabled,
      actionTertiaryBg: actionTertiaryBg ?? this.actionTertiaryBg,
      actionTertiaryBgHover: actionTertiaryBgHover ?? this.actionTertiaryBgHover,
      actionTertiaryBgPressed: actionTertiaryBgPressed ?? this.actionTertiaryBgPressed,
      actionTertiaryBgDisabled: actionTertiaryBgDisabled ?? this.actionTertiaryBgDisabled,
      actionTertiaryFg: actionTertiaryFg ?? this.actionTertiaryFg,
      actionTertiaryFgDisabled: actionTertiaryFgDisabled ?? this.actionTertiaryFgDisabled,
      actionDangerBg: actionDangerBg ?? this.actionDangerBg,
      actionDangerBgHover: actionDangerBgHover ?? this.actionDangerBgHover,
      actionDangerBgPressed: actionDangerBgPressed ?? this.actionDangerBgPressed,
      actionDangerBgDisabled: actionDangerBgDisabled ?? this.actionDangerBgDisabled,
      actionDangerFg: actionDangerFg ?? this.actionDangerFg,
      actionDangerFgDisabled: actionDangerFgDisabled ?? this.actionDangerFgDisabled,
  ...
  FpColors lerp(ThemeExtension<FpColors>? other, double t) {
    ...
    return FpColors(
      ...
      actionPrimaryBgHover: Color.lerp(actionPrimaryBgHover, other.actionPrimaryBgHover, t)!,
      actionPrimaryBgPressed: Color.lerp(actionPrimaryBgPressed, other.actionPrimaryBgPressed, t)!,
      actionPrimaryBgDisabled: Color.lerp(actionPrimaryBgDisabled, other.actionPrimaryBgDisabled, t)!,
      actionPrimaryFg: Color.lerp(actionPrimaryFg, other.actionPrimaryFg, t)!,
      actionPrimaryFgDisabled: Color.lerp(actionPrimaryFgDisabled, other.actionPrimaryFgDisabled, t)!,
      actionSecondaryBg: Color.lerp(actionSecondaryBg, other.actionSecondaryBg, t)!,
      actionSecondaryBgHover: Color.lerp(actionSecondaryBgHover, other.actionSecondaryBgHover, t)!,
      actionSecondaryBgPressed: Color.lerp(actionSecondaryBgPressed, other.actionSecondaryBgPressed, t)!,
      actionSecondaryBgDisabled: Color.lerp(actionSecondaryBgDisabled, other.actionSecondaryBgDisabled, t)!,
      actionSecondaryFg: Color.lerp(actionSecondaryFg, other.actionSecondaryFg, t)!,
      actionSecondaryFgDisabled: Color.lerp(actionSecondaryFgDisabled, other.actionSecondaryFgDisabled, t)!,
      actionTertiaryBg: Color.lerp(actionTertiaryBg, other.actionTertiaryBg, t)!,
      actionTertiaryBgHover: Color.lerp(actionTertiaryBgHover, other.actionTertiaryBgHover, t)!,
      actionTertiaryBgPressed: Color.lerp(actionTertiaryBgPressed, other.actionTertiaryBgPressed, t)!,
      actionTertiaryBgDisabled: Color.lerp(actionTertiaryBgDisabled, other.actionTertiaryBgDisabled, t)!,
      actionTertiaryFg: Color.lerp(actionTertiaryFg, other.actionTertiaryFg, t)!,
      actionTertiaryFgDisabled: Color.lerp(actionTertiaryFgDisabled, other.actionTertiaryFgDisabled, t)!,
      actionDangerBg: Color.lerp(actionDangerBg, other.actionDangerBg, t)!,
      actionDangerBgHover: Color.lerp(actionDangerBgHover, other.actionDangerBgHover, t)!,
      actionDangerBgPressed: Color.lerp(actionDangerBgPressed, other.actionDangerBgPressed, t)!,
      actionDangerBgDisabled: Color.lerp(actionDangerBgDisabled, other.actionDangerBgDisabled, t)!,
      actionDangerFg: Color.lerp(actionDangerFg, other.actionDangerFg, t)!,
      actionDangerFgDisabled: Color.lerp(actionDangerFgDisabled, other.actionDangerFgDisabled, t)!,
      ...
      statusSuccessSolid: Color.lerp(statusSuccessSolid, other.statusSuccessSolid, t)!,
      ...
      statusWarningSolid: Color.lerp(statusWarningSolid, other.statusWarningSolid, t)!,
      ...
      statusDangerSolid: Color.lerp(statusDangerSolid, other.statusDangerSolid, t)!,
